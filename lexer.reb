multiline: has [r l] [r: l: "" until [r: join r [l "^/"] empty? l: input] do r] ; for when the contents of this file are pasted into an R3 console instead of being passed to DO
multiline ; to handle pasting-in the (rapidly upcoming, natch) REBOL header -- this line, like the line above, is also skipped when given to DO (see below :)
REBOL [
